#!/usr/bin/env python3
"""
Configuração completa do CondoTech Solutions
Execute: python3.10 configurar_condotech_completo.py
"""
...
def configurar_sistema():
    """Configura o sistema CondoTech Solutions completamente"""
    
    app = create_app()
    
    with app.app_context():
        print("🚀 CondoTech Solutions - Configuração Completa")
        print("=" * 50)
        ...
        try:
            ...
            if tenant_modules_count == 0:
                db.session.execute(text("""
                    ...
                    SELECT 1, id, 1, ? FROM modulos WHERE ativo = 1
                """), (datetime.now(),))
