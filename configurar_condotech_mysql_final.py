#!/usr/bin/env python3
"""
Configuração FINAL do CondoTech Solutions para MySQL
Execute: python3.10 configurar_condotech_mysql_final.py
"""
...
def configurar_sistema_mysql():
    ...
    print("🚀 CondoTech Solutions - Configuração FINAL MySQL")
    print("=" * 50)
        ...
        try:
            ...
            if planos_count == 0:
                db.session.execute(text("""
                    INSERT INTO planos (nome, descricao, preco_mensal, max_usuarios, max_moradores, recursos, ativo)
                    VALUES (:nome, :descricao, :preco_mensal, :max_usuarios, :max_moradores, :recursos, :ativo)
                """), {
                    'nome': 'Básico',
            ...
            print("")
            print("🚀 Sistema MySQL 100% funcional!")
